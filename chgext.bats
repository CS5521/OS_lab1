...
#to the destination extension.  For example, 
# chgext 'C' 'cpp'
#would cause the file foo.C to be renamed to foo.cpp as well
#as any other files in the current directory with extension C
#
#If the function is invoked without the proper number of arguments, 
#it prints out the error message: usage: chgext <srcExt> <dstExt>
...
#final test just removes leftover files
